...
//  Break
//
//  Created by andrew Mcdonald on 1/28/15.
...
class ViewController: UIViewController, UICollisionBehaviorDelegate {
    ...
    animator = UIDynamicAnimator(referenceView: gameView)
      ...
      //  collisionBehavior.translatesReferenceBoundsIntoBoundary = true
        ...
        brickBehavior.density = 10000000
        
        paddleBehavior.density = 10000000
        ...
        for brick in brickBehavior.items as [UIView] {
            ...
            if brick.isEqual(item1) || brick.isEqual(item2) {
                ...
                UIView.animateWithDuration(0.3, animations: { () -> Void in
                    ...
                    }, completion: { (succeeded) -> Void in pointsLabel.removeFromSuperview()
...
//        GameData.mainData().currentGame?["livesLost"] = ll
    ...
    func creatBricks(){
        ...
        var (col,row) = grid   //tuple col = 6 row = 4///
